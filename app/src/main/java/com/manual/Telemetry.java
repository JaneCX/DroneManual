...
public class Telemetry {
  ...
  public void read_udp_data(DatagramSocket socket) {
        ...
        try {
            ...
            publish_joystick_info(mode, yaw, throttle, roll, pitch);
    ...
    public void publish_joystick_info(int mode, int yaw, int throttle, int roll, int pitch) {
        SendToTcp = ("joyinfo" + " " + mode + " " + throttle + " " + roll + " " + pitch + " " + yaw);
        //Log.d("Joy", SendToTcp);
    }
  ...
  private void draw_pfd(int AcInd) {
    ...
    muiGraphics.create_pfd2(AcPfd, Double.parseDouble(AircraftData[0].Roll), Double.parseDouble(AircraftData[0].Pitch), Double.parseDouble(AircraftData[SelAcInd].Heading), AircraftData[SelAcInd].Altitude, AircraftData[SelAcInd].Battery, AircraftData[SelAcInd].GpsMode,AircraftData[SelAcInd].AC_DlAlt, GraphicsScaleFactor);
